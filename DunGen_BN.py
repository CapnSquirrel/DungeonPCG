...
Treasure_2_Trap_2 = State( treasure_2_trap_1, name="treasure_2_trap_1" )
...
# print model.predict_proba({'size': 's'})
print model.predict_proba({})
# print model.predict_proba({'treasure_2': '1', 'trap_2': '1', 'empty_2': '1'})[-1]
